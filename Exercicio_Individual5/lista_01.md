...
RESPOSTA: c)Imprime os números pares de 2 a 10. 
...
RESPOSTA: A) let carro = new Carro("Toyota");
...
RESPOSTA: A) "Olá, meu nome é João. Olá, meu nome é Maria."
...
cachorro.descrever(); // Saída: O animal Cachorro tem 5 anos de idade.
